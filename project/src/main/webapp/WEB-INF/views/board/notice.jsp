	...
	<div class="sub--menu">
		...
		<div class="sub--menu--mid">
			<table class="sub--menu--table" border="1">
				...
				<tr>
					<td><a href="/boardfile">자료실</a></td>
				</tr>
				<c:if test="${principal.userRole.equals(\"staff\") }">
					<tr>
						<td><a href="/schedule/list"> Q&A</a></td>
					</tr>
				</c:if>
			</table>
		</div>
			...
			<div class="write--div">
				<form action="/notice/write" method="post" enctype="multipart/form-data">
					<div class="title--container">
						...
						<div class="title">
							<input type="text" class="form-control form-control-sm" name="title" placeholder="제목을 입력하세요" required="required" style="width: 1000px;">
						</div>
					</div>
