...
<div class="container">
    <div id="section1" class="section1" style="display: revert;">
        <div class="wrap-title">
            <p class="pagetitle" style="font-size: 24px; font-weight: bold;">나의 강좌 모음</p>
        </div>
    </div>

        <!--<form name="form">
            <input type="hidden" id="hide_prev_id" name="prev_id">
            <input type="hidden" id="hide_lms_lect_no" name="lect_no">
        </form>-->
        <table id="grid1" class="table table-bordered">
           ...
           <tr>
             ...
             <tbody>
                                <c:forEach items="${seslist}" var="seslist">
                                        <tr>
                                            <td>${seslist.lecNum}</td>
                                            <td>${seslist.lecName}</td>
                                           <!--  <td><fmt:formatDate value="${seslist.lecStartDate}"
                                                    pattern="yyyy-MM-dd"/></td>
                                            <td><fmt:formatDate value="${seslist.lecEndDate}"
                                                 pattern="yyyy-MM-dd"/></td> -->
                                              <td>${seslist.lecEx}</td>
                                                <td>운영중</td>
                                           <td class="align-center" style="width: 200px;">
                                               <button class="btn btn-primary"${seslist.lecNum}> 보기</button>
                                           </td>
