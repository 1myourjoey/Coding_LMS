...
<div class="w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden sm:flex bg-white text-black">
    ...
    <div class="flex mx-auto flex-grow mt-4 flex-col space-y-4 bg-white text-black">
        <button class="h-10 w-12 rounded-md flex items-center justify-center bg-white text-black">
